...
# Load Model DenseNet Pretrained
model = models.densenet121(pretrained=True)
model.classifier = nn.Linear(model.classifier.in_features, NUM_CLASSES)  # Ubah output sesuai jumlah kelas
...
# Simpan history training dan validation
history = {
    "train_loss": [],
    "val_loss": [],
    "val_accuracy": []
...
def train_model():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        # Simpan loss dan akurasi untuk plot
